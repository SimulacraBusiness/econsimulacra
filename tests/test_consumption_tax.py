...
from econsimulacra.events import ConsumptionTax, EventTrigger
...
class TestConsumptionTax:
    ...
    def test_init(self):
        ...
        assert event.period2tax_rates == {
            ("2025-01-01 00:00:00", "2025-01-01 00:10:00"): 0.1,
        }


class TestConsumptionTaxinEnv:
    config = {
        "simulation": {
            "numSteps": 100,
            "events": ["ConsumptionTax"],
        },
        "environment": {
            "space": "gridSpace",
    ...
    def test_step(self) -> None:
        ...
        assert government.inventory_dic["Yen"] > 1000000
