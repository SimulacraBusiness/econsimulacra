...
@dataclass
class InvalidActionHistoryItem:
    """A class representing an invalid action history item in the agent's memory.

    Attributes:
        action_type (str): the type of the invalid action.
        description (str): the description of the invalid action.
        time (int | str): the time of the invalid action.
        time_step (int): the time step of the invalid action.
    """
...
class AgentMemory:
    ...
    Attributes:
        invalid_action_history (Deque[InvalidActionHistoryItem]): the history of the agent's invalid actions.
